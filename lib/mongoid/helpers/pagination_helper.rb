  ...
  module Helpers
    module UrlHelper
      ...
      def next_page_path(scope, options = {})
        Mongoid::Helpers::NextPage.new(self, **options.reverse_merge(current_page: scope.current_page)).url if scope.next_page
      end
      ...
      def prev_page_path(scope, options = {})
        Mongoid::Helpers::PrevPage.new(self, **options.reverse_merge(current_page: scope.current_page)).url if scope.prev_page
      end
