...
module Mongoid
  module Helpers
    ...
    class Paginator < LinkTag
      def initialize(template, window: 4, outer_window: 0, left: 0, right: 0, inner_window: 0, **options) #:nodoc:
      ...
      def page_tag(page)
        @last = LinkPage.new @template, param_name: @param_name, theme: @theme, views_prefix: @views_prefix, internal_params: @params, **@options.merge(page: page)
      end
